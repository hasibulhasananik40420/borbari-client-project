...
import RegistrationHomeForm from "../Home/RegistrationHomeForm";
          ...
          <div className="flex flex-col gap-3 mt-6">
            ...
            <div className="flex gap-1 items-center">
              ...
              <span className="text-[13px]">
                Allow others to see and contact you.
              </span>
            </div>
            ...
            <div className="flex gap-1 items-center">
              ...
              <span className="text-[13px]">
                Refer a friend to borbibi.com you could be earn money.
              </span>
            </div>
          </div>

          <div className="flex flex-col gap-3 ml-5 mt-6">
            <Link className="text-[15px] font-medium" to="/login">
              Login
            </Link>
            <Link className="text-[15px] font-medium" to="/search">
              Search
            </Link>
            <Link className="text-[15px] font-medium" to="/search">
              Advance Search
            </Link>
            <Link className="text-[15px] font-medium" to="/working-progess">
              Working Process
            </Link>
          </div>
